...
class DonHang
{
    ...
    public function addDonHang(
        ...
        try {
            $sql = "INSERT INTO don_hangs 
                (tai_khoan_id, ten_nguoi_nhan, email_nguoi_nhan, sdt_nguoi_nhan, dia_chi_nguoi_nhan, ghi_chu, tong_tien, phuong_thuc_thanh_toan_id, ngay_dat, trang_thai_id, ma_don_hang)
                VALUES 
                (:tai_khoan_id, :ten_nguoi_nhan, :email_nguoi_nhan, :sdt_nguoi_nhan, :dia_chi_nguoi_nhan, :ghi_chu, :tong_tien, :phuong_thuc_thanh_toan_id, :ngay_dat, :trang_thai_id, :ma_don_hang)";
    ...
    public function getDonHangFromUser($taiKhoanId)
    {
        try {
            ...
            echo "Lỗi getDonHangFromUser: " . $e->getMessage();
            return [];
        }
    }
