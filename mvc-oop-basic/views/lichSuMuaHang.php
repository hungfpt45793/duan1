                                ...
                                <tbody>
                                    <?php foreach ($donHangs as $donHang): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $phuongThucThanhToan[$donHang['phuong_thuc_thanh_toan_id']] ?? 'Không có' ?>
                                            </td>

                                            <!-- Trạng thái đơn hàng -->
                                            <td>
                                                <?= $trangThaiDonHang[$donHang['trang_thai_id']] ?? 'Không xác định' ?>
                                            </td>
                                            <td><a href="<?= BASE_URL ?>?act=chi-tiet-mua-hang&id=<?= $donHang['id'] ?>"
                                                    class="btn btn-sqr">
                                                    Chi tiết đơn hàng
                                                </a>
                                            </td>
