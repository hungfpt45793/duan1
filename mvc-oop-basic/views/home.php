    ...
    <section class="slider-area">
        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
            ...
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/1.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                                ...
                                                <div class="price-box">
                                                    <?php if (!empty($sanPham['gia_khuyen_mai'])): ?>
                                                        <span class="price-regular">
                                                            <?= number_format($sanPham['gia_khuyen_mai']) ?> đ
                                                        </span>
                                                        <span class="price-old">
                                                            <del><?= number_format($sanPham['gia_san_pham']) ?> đ</del>
                                                        </span>
                                                    <?php else: ?>
                                                        <span class="price-regular">
                                                            <?= number_format($sanPham['gia_san_pham']) ?> đ
                                                        </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
